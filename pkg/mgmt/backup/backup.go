...
func (c *BkpController) enqueueBkp(obj interface{}) { _ = "STUB: not implemented"; return }
...
func (c *BkpController) addBkp(obj interface{}) { _ = "STUB: not implemented"; return }

// updateBkp is the update event handler for ZFSBackup
func (c *BkpController) updateBkp(oldObj, newObj interface{}) { _ = "STUB: not implemented"; return }

// deleteBkp is the delete event handler for ZFSBackup
func (c *BkpController) deleteBkp(obj interface{}) { _ = "STUB: not implemented"; return }
...
// workqueue.
func (c *BkpController) runWorker() { _ = "STUB: not implemented"; return }

// processNextWorkItem will read a single work item off the workqueue and
// attempt to process it, by calling the syncHandler.
func (c *BkpController) processNextWorkItem() bool { _ = "STUB: not implemented"; return false }
